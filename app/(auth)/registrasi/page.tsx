...
const FormScema = z.object({
  ...
  password: z
    ...
    .min(8, "Password mush have tha 8 characters"),
});
    ...
    <>
      <div className="hidden w-full xl:block xl:w-1/2">
        <div className="px-26 py-17.5 text-center">
          <h1 className="mb-2 text-center text-3xl font-bold">E-Learning</h1>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        ...
                        className="border-stroke text-black  placeholder:text-bodydark"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
